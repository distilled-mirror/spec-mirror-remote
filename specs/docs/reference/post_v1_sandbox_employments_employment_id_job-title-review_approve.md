...
```json
{
  "components": {
    "schemas": {
      ...
      "JobTitleReviewDecisionResponse": {
          ...
          "data": {
            ...
            "properties": {
              "job_title_review": {
                ...
                "properties": {
                  "employment_status": {
                    "description": "The employment's status after the decision. An approval restores the status the employment held before it entered review.",
                    "type": "string"
                  }
                },
                "required": [
        ...
        "title": "JobTitleReviewDecisionResponse",
        "type": "object"
      },
      ...
      "JobTitleReviewDecisionParams": {
        "additionalProperties": false,
        "example": {
          "notes": "Checked the role against the local restrictions."
        },
        "properties": {
          "notes": {
            "description": "The reviewer's notes, recorded on the employment as a Remote admin's would be.",
            "type": "string"
          }
        },
        "title": "JobTitleReviewDecisionParams",
        "type": "object"
      },
      "BadRequestResponse": {
  ...
  "openapi": "3.1.0",
  "paths": {
    "/v1/sandbox/employments/{employment_id}/job-title-review/approve": {
      "post": {
        "callbacks": {},
        "deprecated": false,
        "description": "Approves the job title review an employment is in, without the intervention of a Remote\nadmin, so the integration can be tested against the decision it will see in production.\n\nThe employment returns to the status it held before it entered review, and an\n`employment.job_title_review.approved` webhook event is emitted.\n\nResponds with 422 when the employment is not in a job title review.\n\nThis endpoint is only available in Sandbox, otherwise it will respond with a 404.\n\n## Authentication\n\nThis endpoint accepts any one of the following token types:\n\n- **Company-scoped access token** (`OAuth2AuthorizationCode`) — obtained through the Authorization Code flow or the Refresh Token flow. See [Authentication for partners](https://developer.remote.com/docs/authentication-for-partners).\n- **Customer API token** (`CustomerAPIToken`) — generated by the customer on their Integration Settings page. See [Authorization for customers](https://developer.remote.com/docs/authorization-for-customers).",
        "operationId": "post_v1_sandbox_employments_employment_id_job-title-review_approve",
        "parameters": [
          {
        ...
        "requestBody": {
          "content": {
            "application/json": {
              "schema": {
                "$ref": "#/components/schemas/JobTitleReviewDecisionParams"
              }
            }
          },
          "description": "Job title review decision params",
          "required": false
        },
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/JobTitleReviewDecisionResponse"
                }
              }
            },
            "description": "Success"
        ...
        "summary": "Approve job title review",
        "tags": [
          "Sandbox"
        ]
      }
