---
updatedAt: 2026-08-07T21:03:22.000Z
---
...
```json
{
  "components": {
    "schemas": {
      ...
      "ListDirectOffboardingResponse": {
        "description": "Response schema listing many direct_offboardings",
        "example": {
          "current_page": 1,
          "direct_offboardings": [
            {
              ...
              "id": "offb-abc123",
              "is_confidential_termination": true,
        ...
        "properties": {
          "data": {
            "properties": {
              ...
              "direct_offboardings": {
                "items": {
                  "$ref": "#/components/schemas/DirectOffboarding"
                },
                "type": "array"
              },
              "total_count": {
        ...
        "title": "ListDirectOffboardingResponse",
        "type": "object"
      },
      "NotFoundResponse": {
      ...
      "DirectOffboarding": {
        ...
        "description": "A Global Payroll employment's offboarding record.",
        "example": {
          "employment_id": "emp-xyz789",
          "id": "offb-abc123",
          "is_confidential_termination": true,
        ...
        "properties": {
          ...
          "id": {
            "description": "The unique identifier (UUID) of the offboarding.",
            "type": "string"
          },
          "is_confidential_termination": {
            "description": "Whether the termination is confidential.",
            "nullable": true,
            "type": "boolean"
          },
          "last_working_day": {
            "description": "Last working day of the employee.",
            "format": "date",
            "nullable": true,
            "type": "string"
          },
          "status": {
            "description": "The current status of the offboarding.",
            "enum": [
              "submitted",
              "in_review",
              "rejected",
          ...
          "termination_date": {
            "description": "Date when the employment terminates.",
            "format": "date",
            "nullable": true,
            "type": "string"
          },
          "type": {
            "description": "The type of offboarding.",
            "enum": [
              "termination",
              "resignation",
              "mutual_agreement",
  ...
  "openapi": "3.1.0",
  "paths": {
    "/v1/direct-offboardings": {
      "get": {
        "callbacks": {},
        "deprecated": false,
        "description": "Lists offboardings for global payroll employments, optionally filtered by employment ID.\n\n## Authentication\n\nThis endpoint accepts any one of the following token types:\n\n- **Company-scoped access token** (`OAuth2AuthorizationCode`) — obtained through the Authorization Code flow or the Refresh Token flow. See [Authentication for partners](https://developer.remote.com/docs/authentication-for-partners).\n- **Customer API token** (`CustomerAPIToken`) — generated by the customer on their Integration Settings page. See [Authorization for customers](https://developer.remote.com/docs/authorization-for-customers).\n\n## Scopes\n\n| Category | Read only Scope | Write only Scope (read access implicit) |\n|---|---|---|\n| Manage employments (`employments`) | View offboarding requests (`offboarding:read`) | Manage offboarding (`offboarding:write`) |",
        "operationId": "get_v1_direct-offboardings",
        "parameters": [
          {
          ...
          {
            "description": "Filter by employment model. Currently only 'global_payroll' is supported.",
        ...
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ListDirectOffboardingResponse"
                }
              }
            },
            "description": "Success"
        ...
        "summary": "List Direct Offboardings",
        "tags": [
          "Global Payroll"
        ]
      }
