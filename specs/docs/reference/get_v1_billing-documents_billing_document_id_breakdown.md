  ...
  "components": {
    "schemas": {
      "BillingDocumentBreakdownItem": {
        ...
        "properties": {
          "country_code": {
            "description": "Country code according to ISO 3166-1 3-digit alphabetic codes. May be null for legal-entity-wide lines.",
            "example": "PRT",
            "nullable": true,
            "type": "string"
          },
          ...
          "employment_id": {
            "description": "A unique identifier in UUID v4 format for the employment this cost belongs to. May be null for legal-entity-wide lines that apply to the whole legal entity rather than a single employment.",
