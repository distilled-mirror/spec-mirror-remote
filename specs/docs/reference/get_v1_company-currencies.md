...
```json
{
  "components": {
    "schemas": {
      "CompanyCurrenciesResponse": {
        ...
        "title": "CompanyCurrenciesResponse",
        "type": "object"
      },
      "NotFoundResponse": {
      ...
      "CompanyCurrency": {
        "additionalProperties": false,
        "description": "A currency available for use by a company on the Remote platform.",
        "example": {
          "code": "USD",
          "slug": "usd"
        },
        "properties": {
          ...
          "slug": {
            "description": "A URL-friendly identifier for the currency (e.g., \"usd\", \"eur\").",
            "type": "string"
          }
        },
        "required": [
  ...
  "openapi": "3.1.0",
  "paths": {
    "/v1/company-currencies": {
      "get": {
        "callbacks": {},
        "deprecated": false,
        "description": "List company supported currencies\n\n## Authentication\n\nThis endpoint accepts any one of the following token types:\n\n- **Company-scoped access token** (`OAuth2AuthorizationCode`) — obtained through the Authorization Code flow or the Refresh Token flow. See [Authentication for partners](https://developer.remote.com/docs/authentication-for-partners).\n- **Client credentials access token** (`OAuth2ClientCredentials`) — obtained through the Client Credentials flow or the Refresh Token flow. See [Authentication for partners](https://developer.remote.com/docs/authentication-for-partners).\n- **Client token** (`ClientToken`) — a partner `client_token`, accepted only on marketing endpoints. See [Authentication for partners](https://developer.remote.com/docs/authentication-for-partners).\n\n## Scopes\n\n| Category | Read only Scope | Write only Scope (read access implicit) |\n|---|---|---|\n| Manage company resources (`company_admin`) | View company currencies (`company_currencies:read`) | - |",
        "operationId": "get_v1_company-currencies",
        "parameters": [],
        "responses": {
          "200": {
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/CompanyCurrenciesResponse"
                }
              }
            },
            "description": "Success"
        ...
        "summary": "List company supported currencies",
        "tags": [
          "Currencies"
        ]
      }
