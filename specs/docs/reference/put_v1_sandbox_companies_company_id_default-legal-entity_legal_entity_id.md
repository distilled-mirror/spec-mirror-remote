  ...
  "paths": {
    "/v1/sandbox/companies/{company_id}/default-legal-entity/{legal_entity_id}": {
      "put": {
        ...
        "operationId": "put_v1_sandbox_companies_company_id_default-legal-entity_legal_entity_id",
        "parameters": [
          {
          ...
          {
            "description": "Legal Entity ID to set as the new default",
            "example": "5bdc2cb9-6bda-4cf7-bc6e-0b122791e52a",
            "in": "path",
        ...
        "summary": "Reassign default legal entity",
        "tags": [
          "Sandbox"
        ]
      }
