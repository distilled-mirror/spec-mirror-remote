  ...
  "components": {
    "schemas": {
      ...
      "ProbationCompletionLetter": {
        ...
        "description": "Probation completion letter request",
        "example": {
        ...
        "properties": {
          ...
          "letter": {
            "$ref": "#/components/schemas/ProbationCompletionLetterFile"
          },
          "status": {
            "enum": [
              "submitted",
        ...
        "title": "ProbationCompletionLetter",
        "type": "object"
      },
      "ProbationCompletionLetterResponse": {
        "additionalProperties": false,
        "description": "Probation completion letter request response",
        "example": {
          "data": {
        ...
        "properties": {
          "data": {
            ...
            "properties": {
              "probation_completion_letter": {
                "$ref": "#/components/schemas/ProbationCompletionLetter"
              }
            },
            "required": [
              "probation_completion_letter"
        ...
        "title": "ProbationCompletionLetterResponse",
        "type": "object"
      },
      ...
      "CreateProbationCompletionLetterParams": {
        ...
        "title": "CreateProbationCompletionLetterParams",
        "type": "object"
      },
      "DateTimeIso8601": {
      ...
      "ProbationCompletionLetterFile": {
        "additionalProperties": false,
        "description": "Probation completion letter file",
        "example": {
          "id": "f4e2f1fe-2056-4d9f-b9e0-ea322b781eb7",
          "inserted_at": "2021-01-01T00:00:00Z",
          "name": "2024-05-29_Hero8_ProbationConfirmationLetter.pdf",
        ...
        "title": "ProbationCompletionLetterFile",
        "type": "object"
      }
    },
    "securitySchemes": {
