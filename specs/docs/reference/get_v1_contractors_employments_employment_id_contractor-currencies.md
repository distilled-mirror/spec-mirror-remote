  ...
  "components": {
    "schemas": {
      ...
      "ContractorCurrencyResponse": {
        ...
        "description": "Schema for listing contractor currencies",
        "example": {
          "data": [
            {
              "code": "CAD",
        ...
        "properties": {
          "data": {
            "items": {
              "$ref": "#/components/schemas/ContractorCurrencyItem"
            },
            "type": "array"
          }
        },
        ...
        "title": "ContractorCurrencyResponse",
        "type": "object"
      },
      "ValidationError": {
        "example": {
